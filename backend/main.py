...
# TODO: Re-enable OpenAPI docs before going to production!
# Docs were disabled here to prevent 502 errors caused by YOLO model conflicts.
app = FastAPI(
    docs_url=None,
    redoc_url=None,
    openapi_url=None
...
# Load YOLO model at global level (may conflict with OpenAPI in some cases)
try:
