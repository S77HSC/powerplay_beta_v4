  ...
  return (
    <main className="min-h-screen text-white font-[Rajdhani] p-6 flex flex-col items-center relative overflow-hidden">
      ...
      <div className="grid grid-cols-12 auto-rows-[minmax(150px,_auto)] gap-4 w-full max-w-[1600px] z-10">
        ...
        {/* Training Zone */}
        <Link href="/training-zone" className="group col-span-6 row-span-2 bg-gray-800 p-4 rounded-xl relative overflow-hidden shadow-lg hover:scale-105 transition-transform duration-200">
        ...
        {/* Game Zone */}
        <Link href="/game-zone" className="group col-span-3 row-span-2 bg-gray-800 p-4 rounded-xl shadow-md hover:scale-105 transition-transform duration-200 relative overflow-hidden">
        ...
        {/* Locker Room */}
        <Link href="/locker-room" className="col-span-3 row-span-1 bg-gray-800 p-3 rounded-xl shadow-md flex flex-col items-center justify-center">
        ...
        {/* Notifications */}
        <Link href="/notifications" className="col-span-3 row-span-1 bg-gray-800 p-3 rounded-xl shadow-md flex flex-col items-center justify-center">
        ...
        {/* Daily Challenge */}
        <Link href="/skill-session" className="col-span-3 row-span-1 bg-gray-800 p-4 rounded-xl shadow-md flex flex-col justify-between">
        ...
        {/* Live Feed */}
        <div className="col-span-3 row-span-1 bg-gray-800 p-4 rounded-xl shadow-md overflow-hidden">
        ...
        {/* Global Standings */}
        <div className="col-span-3 row-span-1 bg-gray-800 p-3 rounded-xl shadow-md">
