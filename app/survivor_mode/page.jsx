...
export default function SacrificeGame() {
  ...
  return (
    <div className="w-screen h-screen bg-black text-white p-4 overflow-auto">
      {introShown ? (
          ...
          <div className="text-center mb-6">
            ...
            {[3, 5, 7].map(size => (
              <button
                ...
                className={`btn mx-1 ${teamSize === size ? 'bg-sacrifice-purple' : ''}`}
              >
                {size} a-side
              </button>
            ))}
          ...
          <div className="text-center mb-6">
            ...
            {[5, 10, 15, 20].map(min => (
              <button
                ...
                className={`btn mx-1 ${matchTime === min * 60 ? 'bg-sacrifice-purple' : ''}`}
              >
                {min} min
              </button>
            ))}
