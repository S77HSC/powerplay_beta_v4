// Full merged and updated WorkoutBuilder using dynamic import of FootballTouchTracker
...
export default function WorkoutBuilder() {
  ...
  useEffect(() => {
    if (prepCountdown === 3) {
      // Fire backend start right at the beginning of the countdown
      fetch('http://localhost:5000/start')
        .then(() => console.log('Backend tracking started'))
        .catch((err) => console.error('Failed to start backend tracking:', err));
    }
